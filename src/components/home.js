  ...
  return (
    <div className='card text-center' id='landing'>
      ...
      <div className='card-body'>
        <p className='card-text' id='bodytxt'>
          BadBank is here to serve your financial needs. If you would prefer
          speaking with a live representative, call 1 (800) XXX - XXXX. Hours of
          Operation: Monday - Friday, 8AM - 5pm EST
        </p>
        <img src={logo} style={{ padding: '10px' }}></img>
        <Link to='/CreateAccount' class='btn btn-primary'>
          Get Started!
        </Link>
      </div>
      <div className='card-footer text-muted'>@2021 BadBank</div>
    </div>
  )
}
